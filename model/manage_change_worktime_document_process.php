...
*/
                    ...
                    $sMessage = [
                        "type" => "flex",
                        "altText" => "เอกสารการขอเปลี่ยนวันและเวลา",
                        "contents" => [
                            "type" => "bubble",
                            "body" => [
                                "type" => "box",
                                ...
                                "contents" => [
                                    ...
                                    [
                                        "type" => "text",
                                        "text" => "🕓 **วันที่ทำงานปกติ**: " . $date_leave_start . " " . $time_leave_start . " - " . $time_leave_to,
                                        "margin" => "md"
                                    ],
                                    [
                                        "type" => "text",
                                        "text" => "🔄 **เปลี่ยนเป็นวันที่**: " . $date_leave_start_c . " " . $time_leave_start_c . " - " . $time_leave_to_c,
                                        "margin" => "md"
                                    ],
                                    [
                                        "type" => "text",
