                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div style="font-size: 15px; font-weight: bold; text-transform: uppercase; margin-bottom: 1rem;">
                                                เอกสารใบลากิจ ลาสูงสุดได้ <?php echo $_SESSION['L1'] ?> วัน/ปี
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div style="font-size: 15px; font-weight: bold; text-transform: uppercase; margin-bottom: 1rem;">
                                                เอกสารการลาพักผ่อน ลาสูงสุดได้ <?php echo $_SESSION['L3'] ?> วัน/ปี
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div style="font-size: 15px; font-weight: bold; text-transform: uppercase; margin-bottom: 1rem;">
                                                เอกสารการลาป่วย ลาสูงสุดได้ <?php echo $_SESSION['L2'] ?> วัน/ปี
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
