...
try {
    ...
    // ดึงข้อมูลจากฐานข้อมูลต้นทาง (dtime_change_event)
    $sql1 = "SELECT * FROM dtime_change_event";
    ...
    while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
        ...
        $doc_id = $row1['doc_id'];
        $sql2 = "SELECT COUNT(*) FROM dtime_change_event WHERE doc_id = :doc_id";
        ...
        if ($count == 0) {
            $sql3 = "INSERT INTO dtime_change_event (doc_year, doc_id, doc_date, doc_month, emp_id, leave_type_id, dept_id, 
                    date_leave_start, date_leave_to, time_leave_start, time_leave_to, date_leave_start_c, time_leave_start_c, 
                    time_leave_to_c, approve_1_id, approve_1_status, approve_2_id, approve_2_status, remark, status, total_time)
            ...
            $stmt3->execute([
                ...
                'date_leave_start_c' => $row1['date_leave_start_c'],
                'time_leave_start_c' => $row1['time_leave_start_c'],
                'time_leave_to_c' => $row1['time_leave_to_c'],
