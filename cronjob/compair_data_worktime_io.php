...
try {
    ...
    // ดึงข้อมูลจากฐานข้อมูลต้นทาง (worktime_emp_io)
    $sql1 = "SELECT * FROM worktime_emp_io";
    ...
    while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
        ...
        $doc_id = $row1['doc_id'];
        $sql2 = "SELECT COUNT(*) FROM worktime_emp_io WHERE doc_id = :doc_id";
        ...
        if ($count == 0) {
            $sql3 = "INSERT INTO worktime_emp_io (doc_year, doc_id, doc_date, doc_month, emp_id, leave_type_id, dept_id, 
            ...
            $sql4 = "UPDATE worktime_emp_io SET status = :status WHERE doc_id = :doc_id";
