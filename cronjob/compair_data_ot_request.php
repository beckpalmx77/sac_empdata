...
try {
    ...
    // ดึงข้อมูลจากฐานข้อมูลต้นทาง (ot_request)
    $sql1 = "SELECT * FROM ot_request";
    ...
    while ($row1 = $stmt1->fetch(PDO::FETCH_ASSOC)) {
        ...
        $doc_id = $row1['doc_id'];
        $sql2 = "SELECT COUNT(*) FROM ot_request WHERE doc_id = :doc_id";
        ...
        if ($count == 0) {
            $sql3 = "INSERT INTO ot_request (doc_year, doc_id, doc_date, doc_month, emp_id, leave_type_id, dept_id, 
                    date_leave_start, date_leave_to, time_leave_start, time_leave_to, approve_1_id, approve_1_status, approve_2_id, 
                    approve_2_status, remark, status, total_time)
            ...
            $sql4 = "UPDATE ot_request SET status = :status WHERE doc_id = :doc_id";
